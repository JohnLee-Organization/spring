...
import net.lizhaoweb.interceptor.LicenseInterceptor;
 ...
 * a
 * <p>
 * Created by Jhon.Lee on 8/3/2023 11:51 PM
 *
...
public class LicenseConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(licenseInterceptor).addPathPatterns("/**").excludePathPatterns("/license/**");
    }
