...
public class MapReduceConstant {
    ...
    public static class CommonVariables {
        ...
        public static void initMapReduce(Configuration configuration, String[] args) {
            ...
            System.out.println("\tInput[HDFS-Cluster]   : " + hdfsCluster);
            ...
            System.out.println("\tInput[HBase-Root-Dir]   : " + hbaseRoot);
            ...
            System.out.println("\tInput[HBase-ZooKeeper-Quorum]   : " + hbaseZoo);
