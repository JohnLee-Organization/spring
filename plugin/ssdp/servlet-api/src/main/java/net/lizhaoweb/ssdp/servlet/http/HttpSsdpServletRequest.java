 ...
 * a
 * <p>
 * Created by jhon on 2024/6/4 10:34
 *
 * @author <a href="http://www.lizhaoweb.cn">李召(John.Lee)</a>
 * @version 1.0.0
 * @email 404644381@qq.com
 */
public interface HttpSsdpServletRequest extends SsdpServletRequest {
     ...
     * {@link net.lizhaoweb.ssdp.servlet.SsdpServletContext#getContextPath()} method.
     * The context path returned by
     * {@link net.lizhaoweb.ssdp.servlet.SsdpServletContext#getContextPath()}
     ...
     * of the request
     * @see net.lizhaoweb.ssdp.servlet.SsdpServletContext#getContextPath()
     */
     ...
     * {@link net.lizhaoweb.ssdp.servlet.utils.HttpUtils#getRequestURL}.
     *
     * @return a <code>String</code> containing
     * the part of the URL from the
     * protocol name up to the query string
     * @see net.lizhaoweb.ssdp.servlet.utils.HttpUtils#getRequestURL
     */
     ...
     * {@link net.lizhaoweb.ssdp.servlet.SsdpRequestDispatcher#forward}, the server path in the
     ...
     * @see #getSession()
     */
    HttpSsdpSession getSession(boolean create);
