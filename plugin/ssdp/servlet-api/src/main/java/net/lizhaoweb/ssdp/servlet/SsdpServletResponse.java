 ...
 * the {@link SsdpServletOutputStream} returned by {@link #getOutputStream}.
 ...
 * are still evolving.
 * <p>
 * Created by jhon on 2024/6/4 11:38
 *
 * @author <a href="http://www.lizhaoweb.cn">李召(John.Lee)</a>
 * @version 1.0.0
 * @email 404644381@qq.com
 * @see SsdpServletOutputStream
 */
public interface SsdpServletResponse {
     ...
     * <p>See RFC 2047 (<a href="http://www.ietf.org/rfc/rfc2047.txt">http://www.ietf.org/rfc/rfc2047.txt</a>)
    ...
    /**
     * Returns a {@link SsdpServletOutputStream} suitable for writing binary
     ...
     *
     * @return a {@link SsdpServletOutputStream} for writing binary data
     * @throws IllegalStateException if the <code>getWriter</code> method
     *                               has been called on this response
     * @throws IOException           if an input or output exception occurred
     * @see #getWriter
     */
    SsdpServletOutputStream getOutputStream() throws IOException;
