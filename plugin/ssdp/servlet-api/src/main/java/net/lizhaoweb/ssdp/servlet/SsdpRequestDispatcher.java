 ...
 * <p>
 * Created by jhon on 2024/6/4 11:23
 *
 * @author <a href="http://www.lizhaoweb.cn">李召(John.Lee)</a>
 * @version 1.0.0
 * @email 404644381@qq.com
 * @see SsdpServletContext#getRequestDispatcher(java.lang.String)
 * @see SsdpServletContext#getNamedDispatcher(java.lang.String)
 * @see SsdpServletRequest#getRequestDispatcher(java.lang.String)
 */
public interface SsdpRequestDispatcher {
     ...
     * <code>getRequestDispatcher()</code>, the <code>ISsdpServletRequest</code>
     ...
     * subclasses of the {@link SsdpServletRequestWrapper} or {@link SsdpServletResponseWrapper} classes
     * that wrap them.
     *
     * @param request  a {@link SsdpServletRequest} object
     *                 that represents the request the client
     *                 makes of the servlet
     * @param response a {@link SsdpServletResponse} object
     *                 that represents the response the servlet
     *                 returns to the client
     * @throws SsdpServletException      if the target resource throws this exception
     * @throws IOException           if the target resource throws this exception
     * @throws IllegalStateException if the response was already committed
     */
    void forward(SsdpServletRequest request, SsdpServletResponse response) throws SsdpServletException, IOException;
     ...
     *
     * <p>The {@link SsdpServletResponse} object has its path elements
     ...
     * @throws SsdpServletException if the included resource throws this exception
     * @throws IOException      if the included resource throws this exception
     */
    void include(SsdpServletRequest request, SsdpServletResponse response) throws SsdpServletException, IOException;
