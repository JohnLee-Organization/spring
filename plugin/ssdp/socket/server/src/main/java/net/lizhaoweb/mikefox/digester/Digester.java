 ...
 * <p>
 * Created by jhon on 2024/6/8 6:07
 *
...
public class Digester extends DefaultHandler {
        ...
        if (className != null) {
            ...
            for (int i = 0; i < cls.length && (!initialized); i++) {
                try {
                    ...
                    LogFactory.getLog("org.apache.commons.digester.Digester").error("Unable to load property source[" + className + "].", t);
                }
            }
     ...
     */
    protected Logger log = LoggerFactory.getLogger("org.apache.commons.digester.Digester");
    ...
    @Setter
    @Getter
    protected Logger saxLog = LoggerFactory.getLogger("org.apache.commons.digester.Digester.sax");
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes list) throws SAXException {
        ...
        if ((rules != null) && (rules.size() > 0)) {
            for (Rule value : rules) {
                try {
                    if (debug) {
                        log.debug("  Fire begin() for " + value);
                    }
    ...
    protected void configure() {
        ...
        log = LoggerFactory.getLogger("org.apache.commons.digester.Digester");
        saxLog = LoggerFactory.getLogger("org.apache.commons.digester.Digester.sax");
