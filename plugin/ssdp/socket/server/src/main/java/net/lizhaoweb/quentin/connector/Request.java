...
import net.lizhaoweb.mikefox.buf.StringCache;
 ...
 * <p>
 * Created by jhon on 2024/6/11 8:49
 *
...
public class Request implements HttpServletRequest {
     ...
     */
    @Getter
    protected net.lizhaoweb.coyote.Request coyoteRequest;
     ...
     */
    public void setCoyoteRequest(net.lizhaoweb.coyote.Request coyoteRequest) {
     ...
     */
    protected static final String info = "net.lizhaoweb.coyote.catalina.CoyoteRequest/1.0";
     ...
     */
    protected net.lizhaoweb.catalina.connector.Response response = null;

    /**
     * Return the Response with which this Request is associated.
     */
    public net.lizhaoweb.catalina.connector.Response getResponse() {
     ...
     */
    public void setResponse(net.lizhaoweb.catalina.connector.Response response) {
    ...
    public Object getAttribute(String name) {
        ...
        if (name.equals(Globals.DISPATCHER_TYPE_ATTR)) {
            return (internalDispatcherType == null) ? DispatcherType.REQUEST : internalDispatcherType;
    ...
    static boolean isSSLAttribute(String name) {
        return Globals.CERTIFICATES_ATTR.equals(name) || Globals.CIPHER_SUITE_ATTR.equals(name) || Globals.KEY_SIZE_ATTR.equals(name) || Globals.SSL_SESSION_ID_ATTR.equals(name) || Globals.SSL_SESSION_MGR_ATTR.equals(name);
    }
     ...
     * have names starting with "net.lizhaoweb.tomcat" and include:
     * <ul>
     * <li>net.lizhaoweb.tomcat.sendfile.support</li>
     * <li>net.lizhaoweb.tomcat.comet.support</li>
     * <li>net.lizhaoweb.tomcat.comet.timeout.support</li>
     * </ul>
    ...
    public Enumeration<Locale> getLocales() {
        ...
        if (locales.size() > 0) return (new Enumerator<Locale>(locales));
    ...
    public String getParameter(String name) {
        ...
        if (!parametersParsed) parseParameters();
    ...
    public BufferedReader getReader() throws IOException {
        ...
        if (usingInputStream) throw new IllegalStateException(sm.getString("coyoteRequest.getReader.ise"));
    ...
    public RequestDispatcher getRequestDispatcher(String path) {
        ...
        if (servletPath == null) servletPath = getServletPath();
    ...
    public void removeAttribute(String name) {
        ...
        if (name.startsWith("net.lizhaoweb.tomcat.")) {
    ...
    public void setAttribute(String name, Object value) {
        ...
        // Name cannot be null
        if (name == null) throw new IllegalArgumentException(sm.getString("coyoteRequest.setAttribute.namenull"));
        ...
        if (replaced) event = new ServletRequestAttributeEvent(context.getServletContext(), getRequest(), name, oldValue);
        else event = new ServletRequestAttributeEvent(context.getServletContext(), getRequest(), name, value);
    ...
    public boolean isAsyncDispatching() {
        ...
        return (asyncContext.getState() == AsyncContextImpl.AsyncState.DISPATCHING || asyncContext.getState() == AsyncContextImpl.AsyncState.TIMING_OUT || asyncContext.getState() == AsyncContextImpl.AsyncState.STARTED || asyncContext.getState() == AsyncContextImpl.AsyncState.ERROR_DISPATCHING || asyncContext.getState() == AsyncContextImpl.AsyncState.COMPLETING);
    }
    ...
    public void setServletPath(String path) {
        if (path != null) mappingData.wrapperPath.setString(path);
    }
    ...
    public void changeSessionId(String newSessionId) {
        ...
        if (context != null && !context.getServletContext().getEffectiveSessionTrackingModes().contains(SessionTrackingMode.COOKIE)) return;
    ...
    public boolean authenticate(HttpServletResponse response) throws IOException, ServletException {
        ...
        if (config == null) {
            throw new ServletException(sm.getString("coyoteRequest.noLoginConfig"));
        }
    ...
    public void login(String username, String password) throws ServletException {
        ...
        if (BASIC_AUTH.equals(authMethod) || FORM_AUTH.equals(authMethod) || DIGEST_AUTH.equals(authMethod)) {
            ...
            if (principal == null) {
                throw new ServletException(sm.getString("coyoteRequest.authFail", username));
            }
            // Assume if we have a non-null LoginConfig then we must have an
            // authenticator
            context.getAuthenticator().register(this, getResponse(), principal, authMethod, username, password);
        } else {
    ...
    public void logout() throws ServletException {
        context.getAuthenticator().register(this, getResponse(), null, null, null, null);
    }
    ...
    private void parseParts() {
        ...
        if (parts != null || partsParseException != null) return;
            ...
            for (FileItem item : items) {
                ...
                if (part.getFilename() == null) {
                    try {
                        ...
                        parameters.addParameterValues(part.getName(), new String[]{part.getString(encoding)});
                    } catch (UnsupportedEncodingException uee) {
                        try {
                            parameters.addParameterValues(part.getName(), new String[]{part.getString(Parameters.DEFAULT_ENCODING)});
    ...
    protected void parseParameters() {
        ...
        if (enc != null) {
            ...
            parameters.setEncoding(net.lizhaoweb.coyote.Constants.DEFAULT_CHARACTER_ENCODING);
            if (useBodyEncodingForURI) {
                parameters.setQueryStringEncoding(net.lizhaoweb.coyote.Constants.DEFAULT_CHARACTER_ENCODING);
            }
        }

        parameters.handleQueryParameters();

        if (usingInputStream || usingReader) return;

        if (!getMethod().equalsIgnoreCase("POST")) return;
        ...
        if (!("application/x-www-form-urlencoded".equals(contentType))) return;
