 ...
 * <p>
 * Created by jhon on 2024/6/7 12:48
 *
...
//		should we check also hasStrValue ???
    ...
    /**
     * Returns index if the message bytes starts with the specified string.
     *
    ...
    public int getInt() {
        ...
        if (type == T_BYTES) {
            ...
            intValue = Integer.parseInt(Objects.requireNonNull(toString()));
        }
        hasIntValue = true;
        return intValue;
    }
    ...
    public long getLong() {
        ...
        if (type == T_BYTES) {
            ...
            longValue = Long.parseLong(Objects.requireNonNull(toString()));
        }
        hasLongValue = true;
        return longValue;
    }
