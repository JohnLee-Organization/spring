 ...
 *
 * @project : spring
 * @package : net.lizhaoweb.ssdp.server.core
 * @date : 2024-06-04
 * @time : 11:56
 */
package net.lizhaoweb.ssdp.server.core;
...
import net.lizhaoweb.ssdp.servlet.http.HttpSsdpServletResponse;
 ...
 * <p>
 * Created by jhon on 2024/6/4 11:56
 *
 * @author <a href="http://www.lizhaoweb.cn">李召(John.Lee)</a>
 * @version 1.0.0
 * @email 404644381@qq.com
 */
final class ApplicationDispatcher implements AsyncDispatcher, SsdpRequestDispatcher {
    ...
    protected class PrivilegedForward implements PrivilegedExceptionAction<Void> {
        private final SsdpServletRequest request;
        private final SsdpServletResponse response;

        PrivilegedForward(SsdpServletRequest request, SsdpServletResponse response) {
    ...
    protected class PrivilegedInclude implements PrivilegedExceptionAction<Void> {
        ...
        PrivilegedInclude(SsdpServletRequest request, SsdpServletResponse response) {
            this.request = request;
            this.response = response;
        }

        @Override
        public Void run() throws SsdpServletException, IOException {
    ...
    protected class PrivilegedDispatch implements PrivilegedExceptionAction<Void> {
        ...
        PrivilegedDispatch(SsdpServletRequest request, SsdpServletResponse response) {
            this.request = request;
            this.response = response;
        }
     ...
     * state is too complex to pass and return single SsdpServletRequest or SsdpServletResponse objects.
     */
    private static class State {
        State(SsdpServletRequest request, SsdpServletResponse response, boolean including) {
         ...
         */
        SsdpServletRequest outerRequest = null;


        /**
         * The outermost response that will be passed on to the invoked servlet.
         */
        SsdpServletResponse outerResponse = null;

        /**
         * The request wrapper we have created and installed (if any).
         */
        SsdpServletRequest wrapRequest = null;


        /**
         * The response wrapper we have created and installed (if any).
         */
        SsdpServletResponse wrapResponse = null;
        ...
        /**
         * Outermost HttpSsdpServletRequest in the chain
         */
        HttpSsdpServletRequest hrequest = null;

        /**
         * Outermost HttpSsdpServletResponse in the chain
         */
        HttpSsdpServletResponse hresponse = null;
    }
     ...
     * SsdpServletException thrown by the called servlet will be propagated to the caller.
     *
     * @param request  The servlet request to be forwarded
     * @param response The servlet response to be forwarded
     * @throws IOException          if an input/output error occurs
     * @throws SsdpServletException if a servlet exception occurs
     */
    @Override
    public void forward(SsdpServletRequest request, SsdpServletResponse response) throws SsdpServletException, IOException {
        if (Globals.IS_SECURITY_ENABLED) {
            try {
                ...
                if (e instanceof SsdpServletException) {
                    throw (SsdpServletException) e;
                }
                throw (IOException) e;
            }
        } else {
    ...
    private void doForward(SsdpServletRequest request, SsdpServletResponse response) throws SsdpServletException, IOException {
        ...
        if ((servletPath == null) && (pathInfo == null)) {
            ...
            HttpSsdpServletRequest hrequest = state.hrequest;
     ...
     * @throws IOException          if an input/output error occurs
     * @throws SsdpServletException if a servlet error occurs
     */
    private void processRequest(SsdpServletRequest request, SsdpServletResponse response, State state) throws IOException, SsdpServletException {
     ...
     */
    @Override
    public void include(SsdpServletRequest request, SsdpServletResponse response) throws SsdpServletException, IOException {
        if (Globals.IS_SECURITY_ENABLED) {
            try {
    ...
    private void doInclude(SsdpServletRequest request, SsdpServletResponse response) throws SsdpServletException, IOException {
    ...
    @Override
    public void dispatch(SsdpServletRequest request, SsdpServletResponse response) throws SsdpServletException, IOException {
        if (Globals.IS_SECURITY_ENABLED) {
            try {
    ...
    private void doDispatch(SsdpServletRequest request, SsdpServletResponse response) throws SsdpServletException, IOException {
     ...
     * @throws SsdpServletException if a servlet error occurs
     */
    private void invoke(SsdpServletRequest request, SsdpServletResponse response, State state) throws IOException, SsdpServletException {
        ...
        HttpSsdpServletResponse hresponse = state.hresponse;
        SsdpServlet servlet = null;
        IOException ioException = null;
        SsdpServletException servletException = null;
        ...
        if (wrapper.isUnavailable()) {
            ...
            hresponse.sendError(HttpSsdpServletResponse.SC_SERVICE_UNAVAILABLE, sm.getString("applicationDispatcher.isUnavailable", wrapper.getName()));
            unavailable = true;
        }
        ...
        try {
            ...
            servletException = new SsdpServletException(sm.getString("applicationDispatcher.allocateException", wrapper.getName()), e);
            servlet = null;
        }
        ...
        try {
            ...
            ExceptionUtils.handleThrowable(e);
            wrapper.getLogger().error(sm.getString("applicationDispatcher.deallocateException", wrapper.getName()), e);
            servletException = new SsdpServletException(sm.getString("applicationDispatcher.deallocateException", wrapper.getName()), e);
        }
    ...
    private void unwrapRequest(State state) {
        ...
        SsdpServletRequest previous = null;
        SsdpServletRequest current = state.outerRequest;
        while (current != null) {
            ...
            if (current == state.wrapRequest) {
                SsdpServletRequest next = ((ServletRequestWrapper) current).getRequest();
                if (previous == null) {
    ...
    private void unwrapResponse(State state) {
        ...
        SsdpServletResponse previous = null;
        SsdpServletResponse current = state.outerResponse;
        while (current != null) {
            ...
            if (current == state.wrapResponse) {
                SsdpServletResponse next = ((ServletResponseWrapper) current).getResponse();
                if (previous == null) {
     ...
     */
    private SsdpServletRequest wrapRequest(State state) {

        // Locate the request we should insert in front of
        SsdpServletRequest previous = null;
        SsdpServletRequest current = state.outerRequest;
        while (current != null) {
            if (state.hrequest == null && (current instanceof HttpSsdpServletRequest)) {
                state.hrequest = (HttpSsdpServletRequest) current;
            }
        ...
        SsdpServletRequest wrapper = null;
        if ((current instanceof ApplicationHttpRequest) || (current instanceof Request) || (current instanceof HttpSsdpServletRequest)) {
            // Compute a crossContext flag
            HttpSsdpServletRequest hcurrent = (HttpSsdpServletRequest) current;
            boolean crossContext = false;
            if ((state.outerRequest instanceof ApplicationHttpRequest) || (state.outerRequest instanceof Request) || (state.outerRequest instanceof HttpSsdpServletRequest)) {
                HttpSsdpServletRequest houterRequest = (HttpSsdpServletRequest) state.outerRequest;
     ...
     */
    private SsdpServletResponse wrapResponse(State state) {

        // Locate the response we should insert in front of
        SsdpServletResponse previous = null;
        SsdpServletResponse current = state.outerResponse;
        while (current != null) {
            if (state.hresponse == null && (current instanceof HttpSsdpServletResponse)) {
                state.hresponse = (HttpSsdpServletResponse) current;
        ...
        // Instantiate a new wrapper at this point and insert it in the chain
        SsdpServletResponse wrapper = null;
        if ((current instanceof ApplicationHttpResponse) || (current instanceof Response) || (current instanceof HttpSsdpServletResponse)) {
            wrapper = new ApplicationHttpResponse((HttpSsdpServletResponse) current, state.including);
        } else {
    ...
    private void checkSameObjects(SsdpServletRequest appRequest, SsdpServletResponse appResponse) throws SsdpServletException {
        SsdpServletRequest originalRequest = ApplicationFilterChain.getLastServicedRequest();
        SsdpServletResponse originalResponse = ApplicationFilterChain.getLastServicedResponse();
        ...
        boolean same = false;
        SsdpServletRequest dispatchedRequest = appRequest;
        ...
        if (!same) {
            throw new SsdpServletException(sm.getString("applicationDispatcher.specViolation.request"));
        }

        same = false;
        SsdpServletResponse dispatchedResponse = appResponse;
        ...
        if (!same) {
            throw new SsdpServletException(sm.getString("applicationDispatcher.specViolation.response"));
        }
    }
