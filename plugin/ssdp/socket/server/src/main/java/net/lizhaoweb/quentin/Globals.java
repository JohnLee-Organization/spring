...
/**
 * Global constants that are applicable to multiple packages within Quentin.
 * <p>
 * Created by jhon on 2024/6/7 20:20
 *
...
public final class Globals {
     ...
     */
    public static final String ALT_DD_ATTR = "net.lizhaoweb.quentin.deploy.alt_dd";
     ...
     */
    public static final String CLASS_LOADER_ATTR = "net.lizhaoweb.quentin.classloader";

    /**
     * Request dispatcher state.
     */
    public static final String DISPATCHER_TYPE_ATTR = "net.lizhaoweb.quentin.core.DISPATCHER_TYPE";

    /**
     * Request dispatcher path.
     */
    public static final String DISPATCHER_REQUEST_PATH_ATTR = "net.lizhaoweb.quentin.core.DISPATCHER_REQUEST_PATH";

    /**
     * The JNDI directory context which is associated with the context. This
     * context can be used to manipulate static files.
     */
    public static final String RESOURCES_ATTR = "net.lizhaoweb.quentin.resources";
     ...
     */
    public static final String CLASS_PATH_ATTR = "net.lizhaoweb.quentin.jsp_classpath";
     ...
     * if any.
     */
    public static final String JSP_FILE_ATTR = "net.lizhaoweb.quentin.jsp_file";
     ...
     */
    public static final String MBEAN_REGISTRY_ATTR = "net.lizhaoweb.quentin.Registry";
     ...
     */
    public static final String MBEAN_SERVER_ATTR = "net.lizhaoweb.quentin.MBeanServer";
     ...
     */
    public static final String NAMED_DISPATCHER_ATTR = "net.lizhaoweb.quentin.NAMED";
     ...
     */
    public static final String SSI_FLAG_ATTR = "net.lizhaoweb.quentin.ssi.SSIServlet";
     ...
     */
    public static final String WELCOME_FILES_ATTR = "net.lizhaoweb.quentin.WELCOME_FILES";
     ...
     * compliance.
     */
    public static final boolean STRICT_SERVLET_COMPLIANCE = Boolean.valueOf(System.getProperty("net.lizhaoweb.quentin.STRICT_SERVLET_COMPLIANCE", "false")).booleanValue();
     ...
     *
     */
    public static final String ASYNC_SUPPORTED_ATTR = "net.lizhaoweb.quentin.ASYNC_SUPPORTED";


    /**
     * Default domain for MBeans if none can be determined
     */
    public static final String DEFAULT_MBEAN_DOMAIN = "Quentin";
