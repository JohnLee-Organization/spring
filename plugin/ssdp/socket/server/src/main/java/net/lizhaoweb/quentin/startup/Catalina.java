 ...
 *
 * @project : spring
 * @package : net.lizhaoweb.quentin.startup
 * @date : 2024-06-08
 * @time : 05:34
 */
package net.lizhaoweb.quentin.startup;
...
import net.lizhaoweb.mikefox.digester.Rule;
import net.lizhaoweb.mikefox.res.StringManager;
import net.lizhaoweb.quentin.Container;
 ...
 * <p>
 * Created by jhon on 2024/6/8 5:34
 *
...
public class Catalina {
    ...
    public void stopServer(String[] arguments) {
        ...
        try {
            if (getServer().getPort() > 0) {
                Socket socket = new Socket(getServer().getAddress(), getServer().getPort());
    ...
    public void load() {
        ...
        try {
            ...
            if (Boolean.getBoolean("org.apache.catalina.startup.EXIT_ON_INIT_FAILURE")) throw new java.lang.Error(e);
...
final class SetParentClassLoaderRule extends Rule {
    ...
    public void begin(String namespace, String name, Attributes attributes) throws Exception {
        if (digester.getLogger().isDebugEnabled()) digester.getLogger().debug("Setting parent class loader");
