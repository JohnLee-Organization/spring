...
import net.lizhaoweb.mikefox.modeler.modules.ModelerSource;
 ...
 * <p>
 * Created by jhon on 2024/6/7 8:39
 *
...
//                    localRegistry.key=key;
    ...
    public ManagedBean findManagedBean(String name) {
        ...
        if (mb == null) mb = descriptorsByClass.get(name);
        return mb;
    }
    ...
    public String[] findManagedBeans(String group) {
        ...
        for (ManagedBean item : descriptors.values()) {
            if ((group == null)) {
...
//            objValue = value;
//        } else
        if ("javax.management.ObjectName".equals(type) || "ObjectName".equals(type)) {
            try {
    ...
    public List<ObjectName> load(String sourceType, Object source, String param) throws Exception {
        ...
        if (source instanceof DynamicMBean) {
            ...
            inputsource = Files.newInputStream(((File) source).toPath());
            type = param;
            if (sourceType == null) {
                sourceType = sourceTypeFromExt(location);
            }
        ...
        return ds.loadDescriptors(this, location, type, inputsource);
    }
    ...
    private ModelerSource getModelerSource(String type) throws Exception {
        ...
        return (ModelerSource) c.newInstance();
    }
