 ...
 * <p>
 * Created by jhon on 2024/5/30 16:21
 *
...
public class HttpServlet extends GenericServlet implements Serializable {
     ...
     * {@link net.lizhaoweb.ssdp.servlet.ServletResponse#setContentLength} method),
     ...
     * @see net.lizhaoweb.ssdp.servlet.ServletResponse#setContentType
     */
     ...
     *                          could not be handled
     * @see net.lizhaoweb.ssdp.servlet.ServletOutputStream
     * @see net.lizhaoweb.ssdp.servlet.ServletResponse#setContentType
     */
    ...
    private Method[] getAllDeclaredMethods(Class<?> c) {
        ...
        if (c.equals(net.lizhaoweb.ssdp.servlet.http.HttpServlet.class)) {
            return null;
        }
     ...
     * {@link net.lizhaoweb.ssdp.servlet.Servlet#service} method. There's no
     ...
     *                          cannot be handled
     * @see net.lizhaoweb.ssdp.servlet.Servlet#service
     */
