...
import net.lizhaoweb.sys.area.util.PinYinUtils;
...
public class DistrictService implements IDistrictService {
     ...
     */
    public void importAndAnalysisDistrict(String importDataFile, Date statisticalDate) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (district.getName().length() > 0) {
                    String apiPinYin = PinYinUtils.convertPinYinFromLocal(district.getName(), PinYinUtils.PIN_YIN_SEPARATOR);
                    district.setPinYin(PinYinUtils.capitalizePinYin(apiPinYin, PinYinUtils.PIN_YIN_SEPARATOR_REGEX, ""));
                    district.setShortPinYin(PinYinUtils.capitalizeShortPinYin(apiPinYin, PinYinUtils.PIN_YIN_SEPARATOR_REGEX, ""));
                }
                district.setState(0x01);
                district.setStatisticalDate(statisticalDate);
