package net.lizhaoweb.spring.mybatis.actable.manager.common;

import net.lizhaoweb.spring.mybatis.actable.command.PageResultCommand;
import net.lizhaoweb.spring.mybatis.actable.command.SaveOrUpdateDataCommand;
import net.lizhaoweb.spring.mybatis.actable.dao.common.BaseCRUDMapper;
import net.lizhaoweb.spring.mybatis.actable.utils.ColumnUtils;
import net.lizhaoweb.spring.mybatis.actable.utils.FieldUtils;
...
public class BaseCRUDManagerImpl implements BaseCRUDManager {
     ...
     * 根据实体对象的非Null字段作为Where条件查询结果集，如果对象的属性值都为null则返回全部数据等同于selectAll+分页
     *
     * @param t   实体对象(如果要支持分页实体对象可以继承net.lizhaoweb.spring.mybatis.actable.command.BaseModel)
