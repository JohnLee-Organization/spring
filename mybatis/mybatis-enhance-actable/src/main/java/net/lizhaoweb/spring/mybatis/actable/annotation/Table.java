...
public @interface Table {
     ...
     * 仅支持net.lizhaoweb.spring.mybatis.actable.constants.MySqlCharsetConstant中的枚举字符集
     *
     * @return
     */
     ...
     * 仅支持net.lizhaoweb.spring.mybatis.actable.constants.MySqlEngineConstant中的存储引擎枚举
     *
     * @return
     */
